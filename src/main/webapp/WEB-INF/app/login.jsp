		...
		<div class="row align-items-center justify-content-between">
			<div class="col-xl-6 pe-xxl-5">
				...
				<form action="login" method="POST"
					class="contact-form ajax-contact pb-xl-0 space-bottom">
					<div class="row">
						...
						<div class="form-group style-border2 col-md-6">
							<input type="password" class="form-control" name="password" id="password"
								placeholder="Mot de passe"> <i class="fal fa-key"></i>
						</div>
			...
			<div class="col-xl-6 ps-xxl-5">
				<img src="http://vgboxart.com/resources/render/4057_paper-mario-prev.png" alt="mario" style="max-height:280px">
			</div>
		</div>
	</div>
</div>