                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="game-card gradient-border">
                                    ...
                                    <div class="game-card-details">
                                        <h3 class="box-title"><a href="tournament-details.html">The Hunter Killer</a></h3>
                            ...
                            <div class="swiper-slide">
                                <div class="game-card gradient-border">
                                    ...
                                    <div class="game-card-details">
                                        <h3 class="box-title"><a href="tournament-details.html">Net Remaining Monies</a></h3>
                            ...
                            <div class="swiper-slide">
                                <div class="game-card gradient-border">
                                    ...
                                    <div class="game-card-details">
                                        <h3 class="box-title"><a href="tournament-details.html">Duty Balck Ops</a></h3>
                                        <p class="game-content">Entry Fee:<span class="text-theme">$10.00</span></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="game-card gradient-border">
                                    ...
                                    <div class="game-card-details">
                                        <h3 class="box-title"><a href="tournament-details.html">League of Legends</a></h3>
                                        <p class="game-content">Entry Fee:<span class="text-theme">$10.00</span></p>
                                    </div>
                                </div>
                            </div>
