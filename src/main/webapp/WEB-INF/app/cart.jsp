<div class="th-cart-wrapper space-top space-extra-bottom" style="padding-top:1em">
	<div class="container">
		<c:if test="${ 1 > 2 }">
					...
					<c:if test="${NbGamesInCart > 0}">
						...
						<tr>
                            <td colspan="6" class="actions">
                                <button type="submit" class="th-btn">Mettre &#xE0; jour le panier</button>
                                <a href="store" class="th-btn">Continuer le shopping</a>
                            </td>
                        </tr>
					</c:if>
			...
			<div class="col-md-8 col-lg-7 col-xl-6">
				...
				<table class="cart_totals">
					<tbody>
						<tr>
							<td>Cart Subtotal</td>
							<td data-title="Cart Subtotal"><span class="amount"><bdi id="cartSubTotal"></bdi></span></td>
						</tr>
						<tr class="shipping">
					...
					<tfoot>
						<tr class="order-total">
							<td>Order Total</td>
							<td data-title="Total"><strong><span class="amount" id="cartTotal"><bdi>
